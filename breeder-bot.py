...
async def on_message(message):
    ...
    foodList = ['사탕','초콜릿','물','짜장면','짬뽕','치킨','족발','라면','피자','파스타','돈까스','김치볶음밥','양꼬치','돼지국밥','마라탕','순대국밥','떡볶이','갈비탕','냉면','밀면','쌀국수','볶음밥','삼겹살','소고기','회','초밥','우동','쫄면','육회','찜닭','감자탕','커피','햄버거','김밥','보쌈','라멘','비빔밥','아무거나','곰젤리','콜라','사이다','맥주','쭈꾸미','곱창','갈비찜','소바','부대찌개','김치찌개','된장찌개','스테이크','빵','츄러스','치즈케이크','샐러드','요거트','죽','덮밥','샤브샤브','월남쌈','전골']
